...
function getPromiseCallback(obj, callback, callbackType, clonePreviousArg) {
  ...
  } else if (error && callbackType === "$data") {
    throw new Error("Symbol $ in arguments only can be used with $data");
  }
...
// Freeze an Seal the constructor fucntion Receptus so it can't be modified.
